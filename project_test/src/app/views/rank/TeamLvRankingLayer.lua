...
function TeamLvRankingLayer:selectedIndex(index)
	...
	NetHandler.gameRequest("ShowTeamDefenseInfo", {param1 = teamData.userId, param2 = 4, param3 = teamData.score})
end
