...
local GameSignInSeven = class("GameSignIn")

function GameSignInSeven:ctor(params)
	self.id = params.id
...
function GameSignInSeven:getItemsArr()
	local arr = {}
...
function GameSignInSeven:getShowArr()
	local arr = {}
	for i,v in pairs(self.items) do
		table.insert(arr, {
